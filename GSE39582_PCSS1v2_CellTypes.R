...
mydir <- c("data/GSE39582/") #required data files for the GSE39582 dataset
...
path_plots <- c("Figures/GSE39582/")# create a directory to save the plots
...
f_name <- paste0(path_plots,"PCSS1v2_CellTypes_GSE39582.png")
